...
<div class="col-md-4">
{!! Form::text('barang_id',$Bmasuk->id, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('kode_barang',$Bmasuk->barang->kode_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('nama_barang',$Bmasuk->barang->nama_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('tipe_barang',$Bmasuk->barang->kategori->nama_kategori, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::textarea('keterangan', $Bmasuk->keterangan, ['class'=>'form-control']) !!}
...
<div class="col-md-4">
{!! Form::text('jumlah', $Bmasuk->jumlah, ['class'=>'form-control',
'placeholder' => 'Jumlah']) !!}
