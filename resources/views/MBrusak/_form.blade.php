...
<div class="col-md-4">
{!! Form::text('barang_id',$Barang->id, ['class'=>'form-control']) !!}
...
<div class="col-md-4">
{!! Form::text('tipe_barang',$Barang->kategori->nama_kategori, ['class'=>'form-control']) !!}
...
<div class="col-md-4">
{!! Form::text('satuan',$Barang->satuan->nama_satuan, ['class'=>'form-control']) !!}
