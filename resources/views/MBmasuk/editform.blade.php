...
<div class="col-md-4">
{!! Form::text('barang_id',$MBmasuk->id, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('kode_barang',$MBmasuk->barang->kode_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('nama_barang',$MBmasuk->barang->nama_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('tipe_barang',$MBmasuk->barang->kategori->nama_kategori, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::textarea('keterangan', $MBmasuk->keterangan, ['class'=>'form-control']) !!}
...
<div class="col-md-4">
{!! Form::text('jumlah', $MBmasuk->jumlah, ['class'=>'form-control',
'placeholder' => 'Jumlah']) !!}
