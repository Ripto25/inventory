...
@if (session()->has('flash_notification.message'))
	...
	<div class="container-fluid spark-screen">
		...
		<span> &nbsp &nbsp	&nbsp<a href="{{ asset('member/memberbmasuk/create')}}" class="btn btn-success btn-sm"> Tambah Barang</a></span>	
									...
									<td>
										<div class="btn-group">
			                    			<button type="button" class="btn btn-sm"><b>	                    			
					                    		...
					                    		<a href="memberbmasuk/{{ $Barang->id }}/edit"><i class="icon-pencil"></i>Edit</a></b></button>
