...
<div class="col-md-4">
{!! Form::text('barang_id',$Bkeluar->id, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('kode_barang',$Bkeluar->barang->kode_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('nama_barang',$Bkeluar->barang->nama_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('tipe_barang',$Bkeluar->barang->kategori->nama_kategori, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::textarea('keterangan', $Bkeluar->keterangan, ['class'=>'form-control']) !!}
...
<div class="col-md-4">
{!! Form::text('jumlah', $Bkeluar->jumlah, ['class'=>'form-control',
'placeholder' => 'Jumlah']) !!}
...
<div class="col-md-4">
{!! Form::text('peminta',  $Bkeluar->peminta, ['class'=>'form-control',
'placeholder' => 'peminta']) !!}
...
<div class="form-group {{ $errors->has('role') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
        {!! Form::select('divisi', [''=>'','Counter' => 'Counter', 'Produksi' => 'Produksi', 'Security' => 'Scurity'], $Bkeluar->divisi, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
