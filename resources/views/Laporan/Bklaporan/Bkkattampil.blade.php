...
<tbody>
	<?php $no=1; ?>
@foreach ($Barang as $BKeluars)
<tr>
									<td>{{ $no++ }}</td>
									<td> {{ $BKeluars->kode_bk }}</td>									
									<td> {{ $BKeluars->barang->kode_barang }}</td>									
									<td> {{ $BKeluars->barang->nama_barang }}</td>
									<td> {{ $BKeluars->barang->kategori->nama_kategori }}</td>
									<td> {{ $BKeluars->barang->satuan->nama_satuan }}</td>
									<td> {{ $BKeluars->jumlah }}</td>									
									<td> {{ $BKeluars->created_at }}</td>	
									<td> {{ $BKeluars->user }}</td>
</tr>
@endforeach
</tbody>
