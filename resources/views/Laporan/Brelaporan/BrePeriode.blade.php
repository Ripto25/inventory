...
<tbody>
	<?php $no=1; ?>
@foreach ( $ReturPeriode as $BRetur)
<tr>
									<td>{{ $no++ }}</td>
									<td> {{ $BRetur->kode_r }}</td>									
									<td> {{ $BRetur->barang->kode_barang }}</td>									
									<td> {{ $BRetur->barang->nama_barang }}</td>
									<td> {{ $BRetur->barang->kategori->nama_kategori }}</td>
									<td> {{ $BRetur->barang->satuan->nama_satuan }}</td>
									<td> {{ $BRetur->jumlah }}</td>									
									<td> {{ $BRetur->created_at }}</td>	
									<td> {{ $BRetur->user }}</td>
</tr>
@endforeach
</tbody>
