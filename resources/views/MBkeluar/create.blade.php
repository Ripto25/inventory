...
<li class="active">Tambah Data Barang Keluar</li>
</ul></div>
					...
					<form action="{{ url('member/memberbkeluar/create') }}" method="GET">
                        <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Tambah Data Barang Keluar</div>
                    <div class="panel-body">

                        @foreach($kode as $Barang)

                       {!! Form::open(['url' => route('member.memberbkeluar.store'),
                    'method' => 'POST', 'class'=>'form-horizontal']) !!}
                    @include('MBkeluar._form')
                    {!! Form::close() !!}
