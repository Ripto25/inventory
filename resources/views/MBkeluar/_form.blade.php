...
<div class="col-md-4">
{!! Form::text('barang_id',$Barang->id, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('kode_barang',$Barang->kode_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('nama_barang',$Barang->nama_barang, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('tipe_barang',$Barang->kategori->nama_kategori, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('satuan',$Barang->satuan->nama_satuan, ['class'=>'form-control','readonly']) !!}
...
<div class="col-md-4">
{!! Form::text('peminta',  null, ['class'=>'form-control',
'placeholder' => 'peminta']) !!}
...
<div class="form-group {{ $errors->has('role') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4">
        {!! Form::select('divisi', [''=>'','Counter' => 'Counter', 'Produksi' => 'Produksi', 'Security' => 'Scurity'], null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
