...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>5`asec</b></a>
        </div>
...
<div class="row">
        <div class="col-lg-7" align="right">
          ...
          <br>
          <br>
          {{-- <h1><i>Selamat Datang di <br>
          Buku <strong>TAMU LAB.INFORMATIKA</strong><br>
          Teknik Informatika Unwahas</i></h1>  --}}
          <a href="{{ url('/login') }}" class="btn btn-primary btn-lg">Mulai!</a>  
        </div><!-- /col-lg-6 -->
        {{-- <div class="col-lg-5">
...
{{-- <div id="c">
    <div class="container">
        <p>
            <br/>
            <strong>Copyright &copy; 2017 5`asec
            <br/>
